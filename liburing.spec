...
Version  : 2.9
Release  : 12
URL      : https://github.com/axboe/liburing/archive/liburing-2.9/liburing-2.9.tar.gz
Source0  : https://github.com/axboe/liburing/archive/liburing-2.9/liburing-2.9.tar.gz
...
%prep
%setup -q -n liburing-liburing-2.9
cd %{_builddir}/liburing-liburing-2.9
%patch -P 1 -p1
pushd ..
cp -a liburing-liburing-2.9 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1738596322
...
/usr/share/man/man3/io_uring_check_version.3
/usr/share/man/man3/io_uring_clone_buffers.3
/usr/share/man/man3/io_uring_clone_buffers_offset.3
...
/usr/share/man/man3/io_uring_free_reg_wait.3
...
/usr/share/man/man3/io_uring_peek_batch_cqe.3
...
/usr/share/man/man3/io_uring_prep_cmd_discard.3
...
/usr/share/man/man3/io_uring_prep_open.3
/usr/share/man/man3/io_uring_prep_open_direct.3
...
/usr/share/man/man3/io_uring_register_clock.3
...
/usr/share/man/man3/io_uring_submit_and_wait_min_timeout.3
/usr/share/man/man3/io_uring_submit_and_wait_reg.3
...
/usr/share/man/man3/io_uring_wait_cqes_min_timeout.3

%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/liburing-ffi.so.2.9
/V3/usr/lib64/liburing.so.2.9
/usr/lib64/liburing-ffi.so.2
/usr/lib64/liburing-ffi.so.2.9
/usr/lib64/liburing.so.2
/usr/lib64/liburing.so.2.9
