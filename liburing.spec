...
Version  : 2.8
Release  : 11
URL      : https://github.com/axboe/liburing/archive/liburing-2.8/liburing-2.8.tar.gz
Source0  : https://github.com/axboe/liburing/archive/liburing-2.8/liburing-2.8.tar.gz
...
%prep
%setup -q -n liburing-liburing-2.8
cd %{_builddir}/liburing-liburing-2.8
%patch -P 1 -p1
pushd ..
cp -a liburing-liburing-2.8 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1729888207
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/liburing-ffi.so.2.8
/V3/usr/lib64/liburing.so.2.8
/usr/lib64/liburing-ffi.so.2
/usr/lib64/liburing-ffi.so.2.8
/usr/lib64/liburing.so.2
/usr/lib64/liburing.so.2.8
