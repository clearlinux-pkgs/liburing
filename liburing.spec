...
Version  : 2.1
Release  : 3
URL      : https://github.com/axboe/liburing/archive/liburing-2.1/liburing-2.1.tar.gz
Source0  : https://github.com/axboe/liburing/archive/liburing-2.1/liburing-2.1.tar.gz
...
%prep
%setup -q -n liburing-liburing-2.1
cd %{_builddir}/liburing-liburing-2.1
%patch1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1631209448
...
cp %{_builddir}/liburing-liburing-2.1/COPYING %{buildroot}/usr/share/package-licenses/liburing/3704f4680301a60004b20f94e0b5b8c7ff1484a9
cp %{_builddir}/liburing-liburing-2.1/COPYING.GPL %{buildroot}/usr/share/package-licenses/liburing/4cc77b90af91e615a64ae04893fdffa7939db84c
cp %{_builddir}/liburing-liburing-2.1/LICENSE %{buildroot}/usr/share/package-licenses/liburing/36710809dd93101a87fab97bd7e5e34d7bd3615e
cp %{_builddir}/liburing-liburing-2.1/debian/copyright %{buildroot}/usr/share/package-licenses/liburing/804982ee6d3905270c9dd405d4ee811ffc8ab902
%make_install
