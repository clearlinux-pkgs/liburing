...
Source0  : https://github.com/axboe/liburing/archive/liburing-2.4/liburing-2.4.tar.gz
...
%prep
%setup -q -n liburing-liburing-2.4
cd %{_builddir}/liburing-liburing-2.4
%patch -P 1 -p1
pushd ..
cp -a liburing-liburing-2.4 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1686323825
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/liburing-ffi.so.2.4
/V3/usr/lib64/liburing.so.2.4
/usr/lib64/liburing-ffi.so.2
/usr/lib64/liburing-ffi.so.2.4
/usr/lib64/liburing.so.2
/usr/lib64/liburing.so.2.4
