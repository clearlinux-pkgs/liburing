...
Source0  : https://github.com/axboe/liburing/archive/liburing-2.5/liburing-2.5.tar.gz
...
%prep
%setup -q -n liburing-liburing-2.5
cd %{_builddir}/liburing-liburing-2.5
%patch -P 1 -p1
pushd ..
cp -a liburing-liburing-2.5 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1702025341
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/liburing-ffi.so.2.5
/V3/usr/lib64/liburing.so.2.5
/usr/lib64/liburing-ffi.so.2
/usr/lib64/liburing-ffi.so.2.5
/usr/lib64/liburing.so.2
/usr/lib64/liburing.so.2.5
