...
Version  : 2.3
Release  : 5
URL      : https://github.com/axboe/liburing/archive/liburing-2.3/liburing-2.3.tar.gz
Source0  : https://github.com/axboe/liburing/archive/liburing-2.3/liburing-2.3.tar.gz
...
%prep
%setup -q -n liburing-liburing-2.3
cd %{_builddir}/liburing-liburing-2.3
%patch1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1667397438
